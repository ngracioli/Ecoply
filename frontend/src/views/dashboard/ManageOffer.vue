...
import OfferStatsCards from "../../components/dashboard/OfferStatsCards.vue";
import OfferPurchasesTable from "../../components/dashboard/OfferPurchasesTable.vue";
import CreateOfferDialog from "../../components/dashboard/CreateOfferDialog.vue";
import ConfirmDialog from "../../components/shared/ConfirmDialog.vue";
import DeleteOfferModal from "../../components/dashboard/DeleteOfferModal.vue";
