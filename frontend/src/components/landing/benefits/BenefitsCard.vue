...
<template>
  ...
  >
    ...
    <h1 class="text-center text-2xl font-bold text-neutral-700">
      {{ title }}
    </h1>
    <h2 class="text-primary-color mb-6 text-lg font-semibold">
      Venda seu excedente com mais valor
    </h2>
    <h3 class="text-xl leading-relaxed text-neutral-600">
      {{ subtitle }}
    </h3>
  </article>
</template>
